...
const setExecutionProviders = (sessionOptionsHandle, executionProviders, allocs) => {
    for (const ep of executionProviders) {
        ...
        const epNameDataOffset = string_utils_1.allocWasmString(epName, allocs);
        if (wasm_factory_1.getInstance()._OrtAppendExecutionProvider(sessionOptionsHandle, epNameDataOffset) !== 0) {
