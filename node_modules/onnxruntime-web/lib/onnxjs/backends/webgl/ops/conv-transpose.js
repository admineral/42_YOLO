...
const createUnpackedConvTransposeProgramInfo = (inferenceHandler, inputs, metadata, attributes) => {
    ...
    const { activationFunction, applyActivation } = fuse_utils_1.getActivationSnippet(attributes);
    const shaderSource = `
...
const parseConvTransposeAttributes = (node) => {
    ...
    return attribute_with_cache_key_1.createAttributeWithCacheKey(Object.assign({ autoPad, dilations, group, kernelShape, outputPadding, outputShape, pads, strides }, activationAttributes));
};
